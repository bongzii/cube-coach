export const f2lAlgsExpert: Record<number, string[]> = {
  ...
  6: ["(L' u' L) U (L' u L)", "y' (R u R') U' (R u' R')", "y (L u L') U' (L u' L')", "y2 (R' u' R) U (R' u R)"],
  7: [
    "R' F R2 U' R2' F' R",
    "L F' L2' U' L2 F L'",
    "y (f' L' f) U' (L' U L)",
  ...
  14: ["(L' U L) (M' U R U' r') (R U' R')", "y (L U F' L' F) U2 (L' U' L)", "y (L U L') (F U F') U' (L' U L)"],
  15: ["y (R U' R') (M' U' L' U l) (L' U L)", "(R' U' F R F') U2 (R U R')", "(R' U' R) (F' U' F) U (R U' R')"],
